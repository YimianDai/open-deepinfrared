"""Shell Script:
!python tools/train_det.py configs/oscar/oscar_w_noco_head_r18_caffe_fpn_p2_gn-head_1x_sirst_det2noco.py

python tools/train_det.py configs/oscar/sota/oscar_w_noco_head_r18_caffe_fpn_p2_gn-head_1x_sirst_det2noco.py --gpu-id 0 --work-dir work_dirs/oscar_w_noco_head_r18_caffe_fpn_p2_gn-head_1x_sirst_det2noco_gpu_0

python tools/train_det.py configs/oscar/sota/oscar_w_noco_head_r18_caffe_fpn_p2_gn-head_1x_sirst_det2noco.py --gpu-id 1 --work-dir work_dirs/oscar_w_noco_head_r18_caffe_fpn_p2_gn-head_1x_sirst_det2noco_gpu_1

python tools/train_det.py configs/oscar/sota/oscar_w_noco_head_r18_caffe_fpn_p2_gn-head_1x_sirst_det2noco.py --gpu-id 2 --work-dir work_dirs/oscar_w_noco_head_r18_caffe_fpn_p2_gn-head_1x_sirst_det2noco_gpu_2

python tools/train_det.py configs/oscar/sota/oscar_w_noco_head_r18_caffe_fpn_p2_gn-head_1x_sirst_det2noco.py --gpu-id 3 --work-dir work_dirs/oscar_w_noco_head_r18_caffe_fpn_p2_gn-head_1x_sirst_det2noco_gpu_3
...
if depth == 18:
    ...
    neck_cfg['out_channels'] = 256
elif depth == 50:
    backbone_cfg['depths'] = (3, 4, 6, 3)
    backbone_cfg['block'] = 'bottleneck'
    backbone_cfg['pretrained'] = 'open-mmlab://resnet50_v1c'
    neck_cfg['in_channels'] = [256, 512, 1024, 2048]
    neck_cfg['out_channels'] = 256
else:
