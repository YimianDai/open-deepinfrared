...
class SIRSTCls2DetDataset(CustomDataset):
    """Seg2Det on SIRST dataset. The file structure is as followed.
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(SIRSTCls2DetDataset, self).__init__(
        ...
        self.gt_bboxes = [self.get_gt_bbox_by_idx(i) for i in range(len(self))]
